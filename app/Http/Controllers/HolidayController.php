    ...
    public function myHoliday($year, $month)
    {
        ...
        while($start <= $number_of_day)
        {
            ...
            if($holiday_found) {
                ...
                $holidays[$start] = date(optional($general_setting)->date_format, strtotime($holiday_found->from_date)).' '.trans("file.To").' '.date(optional($general_setting)->date_format, strtotime($holiday_found->to_date));
            }
            else {
