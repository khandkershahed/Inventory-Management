    ...
    <div class="table-responsive mb-4">
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$key}}</td>
                    <td data-sort="{{date('Y-m-d', strtotime($data->created_at->toDateString()))}}">{{date(optional($general_setting)->date_format, strtotime($data->created_at->toDateString()))}}</td>
                    ...
                    @else
                        <td></td>
                    @endif
                    <td>{{number_format((float)$credit, optional($general_setting)->decimal, '.', '')}}</td>
                    <td>{{number_format((float)$debit, optional($general_setting)->decimal, '.', '')}}</td>
                    <td>{{number_format((float)$balance, optional($general_setting)->decimal, '.', '')}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
