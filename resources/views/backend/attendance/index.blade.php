        ...
        <table id="attendance-table" class="table">
            ...
            <tbody>
                ...
                <tr data-date="{{$attendance['date']}}" data-employee_id="{{$attendance['employee_id']}}">
                    <td>{{$key}}</td>
                    <td>{{ date(optional($general_setting)->date_format, strtotime($attendance['date'])) }}</td>
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="date" class="form-control date" value="{{date(optional($general_setting)->date_format)}}" required>
                    </div>
                    <div class="col-md-6 form-group">
