        ...
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo">
                ...
                <img src="{{url('logo', optional($general_setting)->site_logo)}}" width="110">
                @else
                <span>{{optional($general_setting)->site_title}}</span>
                @endif
            </div>
          ...
          <div class="copyrights text-center">
            <p>{{trans('file.Developed By')}} <span class="external">{{optional($general_setting)->developed_by}}</span></p>
          </div>
        </div>
      </div>
    </div>
