        ...
        <table id="cash-register-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$cash_register->id}}">
                    ...
                    <td>{{ date(optional($general_setting)->date_format . " h:i:s", strtotime($cash_register->created_at)) }}</td>
                    @if($cash_register->status)
                        <td>N/A</td>
                        <td><div class="badge badge-success">{{trans('file.Active')}}</div></td>
                    @else
                        <td>{{ date(optional($general_setting)->date_format . " h:i:s", strtotime($cash_register->updated_at)) }}</td>
