...
<html>
  <head>
    ...
    <title>{{optional($general_setting)->site_title}} | Challan Invoice</title>
...
<div style="max-width:800px;margin:0 auto">
    ...
    <div id="office-copy">
        ...
        <p>Date: {{date(optional($general_setting)->date_format, strtotime($challan->created_at->toDateString()))}}</p>
