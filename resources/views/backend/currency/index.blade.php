...
<script type="text/javascript">
    ...
    $('#add_exchange_rate,#edit_exchange_rate').on('input',function(){
        ...
        var default_exchange_rate = {{optional($currency)->exchange_rate}};
        if(exchange_rate == default_exchange_rate){
            ...
            $(this).parent().append('<div class="alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><span>'+message+' - {{optional($currency)->name}}</span></div>');
