                        ...
                        {!! Form::open(['route' => ['discounts.update', $lims_discount_data->id], 'method' => 'put']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="valid_from" value="{{date(optional($general_setting)->date_format, strtotime($lims_discount_data->valid_from))}}" required class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
                                	<label>{{trans('file.Valid Till')}} *</label>
                                    <input type="text" name="valid_till" value="{{date(optional($general_setting)->date_format, strtotime($lims_discount_data->valid_till))}}" required class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
