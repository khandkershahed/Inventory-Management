      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="gift-card" style="margin: 0 auto; max-width: 350px; position: relative; color:#fff;">
                ...
                <div class="site-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">@if(optional($general_setting)->site_logo)
                  <img src="{{url('logo', optional($general_setting)->site_logo)}}" height="38px" width="38px">&nbsp;
                  <span style="font-size: 25px;">@endif{{optional($general_setting)->site_title}}</span>
                </div>
              </div>
          </div>
      </div>
