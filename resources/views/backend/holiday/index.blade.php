        ...
        <table id="holiday-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$holiday->id}}">
                    <td>{{$key}}</td>
                    <td>{{ date(optional($general_setting)->date_format, strtotime($holiday->created_at->toDateString())) }}</td>
                    <td>{{ $holiday->user->name }}</td>
                    <td>{{ date(optional($general_setting)->date_format, strtotime($holiday->from_date)) }}</td>
                    <td>{{ date(optional($general_setting)->date_format, strtotime($holiday->to_date)) }}</td>
                    <td>{{$holiday->note}}</td>
                    <td>
                        <div class="btn-group">
                        	...
                        	@endif
                        	<button type="button" class="btn btn-sm btn-primary btn-edit" title="{{trans('file.edit')}}" data-id="{{$holiday->id}}" data-from="{{date(optional($general_setting)->date_format, strtotime($holiday->from_date))}}" data-to="{{date(optional($general_setting)->date_format, strtotime($holiday->to_date))}}" data-note="{{$holiday->note}}" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i></button>
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="from_date" class="form-control date" value="{{date(optional($general_setting)->date_format)}}" required>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>{{trans('file.To')}} *</label>
                        <input type="text" name="to_date" class="form-control date" value="{{date(optional($general_setting)->date_format)}}" required>
                    </div>
