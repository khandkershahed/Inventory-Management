...
@endif
      @php
        if(optional($general_setting)->theme == 'default.css') {
          $color = '#733686';
          $color_rgba = 'rgba(115, 54, 134, 0.8)';
        }
        elseif(optional($general_setting)->theme == 'green.css') {
            $color = '#2ecc71';
            $color_rgba = 'rgba(46, 204, 113, 0.8)';
        }
        elseif(optional($general_setting)->theme == 'blue.css') {
            $color = '#3498db';
            $color_rgba = 'rgba(52, 152, 219, 0.8)';
        }
        elseif(optional($general_setting)->theme == 'dark.css'){
            $color = '#34495e';
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number revenue-data">{{number_format((float)$revenue,optional($general_setting)->decimal, '.', '')}}</div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number return-data">{{number_format((float)$return,optional($general_setting)->decimal, '.', '')}}</div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number purchase_return-data">{{number_format((float)$purchase_return,optional($general_setting)->decimal, '.', '')}}</div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number profit-data">{{number_format((float)$profit,optional($general_setting)->decimal, '.', '')}}</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      $.ajax({
        ...
        success: function(data) {
            data.forEach(function(item){
              var sale_date = dateFormat(item.created_at.split('T')[0], '{{optional($general_setting)->date_format}}')
    ...
    $(document).ready(function(){
      $.ajax({
        ...
        success: function(data) {
            data.forEach(function(item){
              var payment_date = dateFormat(item.created_at.split('T')[0], '{{optional($general_setting)->date_format}}')
              if(item.status == 1){
    ...
    $(document).ready(function(){
      $.ajax({
        ...
        success: function(data) {
            data.forEach(function(item){
              var quotation_date = dateFormat(item.created_at.split('T')[0], '{{optional($general_setting)->date_format}}')
    ...
    function dashboardFilter(data){
        $('.revenue-data').hide();
        $('.revenue-data').html(parseFloat(data[0]).toFixed({{optional($general_setting)->decimal}}));
        $('.revenue-data').show(500);

        $('.return-data').hide();
        $('.return-data').html(parseFloat(data[1]).toFixed({{optional($general_setting)->decimal}}));
        $('.return-data').show(500);

        $('.profit-data').hide();
        $('.profit-data').html(parseFloat(data[2]).toFixed({{optional($general_setting)->decimal}}));
        $('.profit-data').show(500);

        $('.purchase_return-data').hide();
        $('.purchase_return-data').html(parseFloat(data[3]).toFixed({{optional($general_setting)->decimal}}));
