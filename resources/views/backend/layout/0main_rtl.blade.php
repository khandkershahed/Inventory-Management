          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">
                ...
                <a href="{{url('/')}}"><img src="{{url('logo', optional($general_setting)->site_logo)}}" width="115"></a>
                @else
                  <a href="{{url('/')}}"><h1 class="d-inline">{{optional($general_setting)->site_title}}</h1></a>
                @endif
              </span>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{optional($general_setting)->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <span class="external">{{optional($general_setting)->developed_by}}</span></p>
            </div>
          </div>
        </div>
      </footer>
