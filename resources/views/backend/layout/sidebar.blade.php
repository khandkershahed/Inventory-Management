        <ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
            ...
            @endif
            @if (in_array('manufacturing', explode(',', optional($general_setting)->modules)))
                <li>
            ...
            @if (\Auth::user()->role_id != 5)
                ...
                @endif
                @if (in_array('woocommerce', explode(',', optional($general_setting)->modules)))
