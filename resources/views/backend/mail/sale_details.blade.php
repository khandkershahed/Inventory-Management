            ...
            <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
              <tr>
                <td align="center" style="padding:40px 0 30px 0;background:#CCC;">
                  ...
                  <a href="{{url('/')}}"><img src="{{url('logo', optional($general_setting)->site_logo)}}" width="200" style="height:auto;display:block;"></a>
                  @else
                  <a href="{{url('/')}}">
                        ...
                        <table style="border-collapse: collapse; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ccc; padding: 5px">{{number_format((float)($sale_data['total'][$key] / $sale_data['qty'][$key]), optional($general_setting)->decimal, '.', '')}}</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ccc; padding: 5px">{{number_format((float)($sale_data['grand_total'] - $sale_data['paid_amount']), optional($general_setting)->decimal, '.', '')}}</td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                  <td style="padding:0;width:50%;" align="center">
                    <p style="margin:0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;color:#ffffff;">
                      &copy; {{optional($general_setting)->site_title}} {{date('Y')}}<br/>
                    </p>
                  </td>
                </tr>
              </table>
