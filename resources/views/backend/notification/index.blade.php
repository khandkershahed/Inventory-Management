        ...
        <table id="notification-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$notification->id}}">
                    <td>{{$key}}</td>
                    <td>{{ date(optional($general_setting)->date_format, strtotime($notification->created_at)) }}</td>
                    ...
                    <td>{{ date(optional($general_setting)->date_format, strtotime($data->reminder_date)) }}</td>
                    @else
                    <td>N/A</td>
                    @endif
