...
<html>
  <head>
    ...
    <title>{{optional($general_setting)->site_title}} | Shipping Label</title>
            ...
            <tbody>
                <tr>
                    <td rowspan="2" class="text-center">
                        <img src="{{url('logo', optional($general_setting)->site_logo)}}" style="margin:10px 0;" height="120" width="120">
                    </td>
                    <td colspan="3">
                        <strong>From:</strong><br>
                        <strong>{{optional($general_setting)->site_title}}</strong><br>
