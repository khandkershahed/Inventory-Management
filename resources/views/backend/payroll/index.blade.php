        ...
        <table id="payroll-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$payroll->id}}">
                    <td>{{$key}}</td>
                    <td>{{date(optional($general_setting)->date_format, strtotime($payroll->created_at->toDateString())) }}</td>
                    <td>{{ $payroll->reference_no }}</td>
                    <td>{{ $employee->name}}</td>
                    <td>{{ $account->name}}</td>
                    <td>{{ number_format((float)$payroll->amount, optional($general_setting)->decimal, '.', '')}}</td>
