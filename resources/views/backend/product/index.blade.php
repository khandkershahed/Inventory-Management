...
<section>
    <div class="container-fluid">
        ...
        @endif
        @if( in_array("products-edit", $all_permission) && in_array('ecommerce',explode(',',optional($general_setting)->modules)) )
...
<script>
    ...
    var logoUrl = <?php echo json_encode(url('logo', optional($general_setting)->site_logo)) ?>;
