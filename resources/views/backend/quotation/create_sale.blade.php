                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price">{{ number_format((float)$product_quotation->net_unit_price, optional($general_setting)->decimal, '.', '')}} </td>
                                                        <td class="discount">{{ number_format((float)$product_quotation->discount, optional($general_setting)->decimal, '.', '')}}</td>
                                                        <td class="tax">{{ number_format((float)$product_quotation->tax, optional($general_setting)->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$product_quotation->total, optional($general_setting)->decimal, '.', '')}}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th id="total-discount">{{ number_format((float)$lims_quotation_data->total_discount, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th id="total-tax">{{ number_format((float)$lims_quotation_data->total_tax, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th id="total">{{ number_format((float)$lims_quotation_data->total_price, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
...
<script type="text/javascript">
    ...
    if(!$('input[name="order_discount_value"]').val())
        $('input[name="order_discount_value"]').val('{{number_format(0, optional($general_setting)->decimal, '.', '')}}');
    $('#order_discount').text(parseFloat($('input[name="order_discount_value"]').val()).toFixed({{optional($general_setting)->decimal}}));
