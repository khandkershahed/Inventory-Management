        ...
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="badge badge-danger">{{date(optional($general_setting)->date_format, strtotime($product->expired_date))}}</div>
                    </td>
                    @else
                    <td>
                        <div class="badge badge-warning">{{date(optional($general_setting)->date_format, strtotime($product->expired_date))}}</div>
                    </td>
                    @endif
                    <td>{{number_format((float)($product->qty), optional($general_setting)->decimal, '.', '')}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
