					...
					<div class="col-md-6 offset-md-3 mt-3 mb-3">
						<div class="row">
							<div class="col-md-6">
								...
								<h2><strong>{{number_format((float)$total_item, optional($general_setting)->decimal, '.', '')}}</strong></h2>
							</div>
							<div class="col-md-6">
								<span>Total {{trans('file.Quantity')}}</span>
								<h2><strong>{{number_format((float)$total_qty, optional($general_setting)->decimal, '.', '')}}</strong></h2>
							</div>
						</div>
					</div>
