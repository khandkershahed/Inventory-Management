    ...
    function calculateTotal() {
        ...
        $(".is-return").each(function(i) {
            if ($(this).is(":checked")) {
                ...
                $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .sub-total').text(parseFloat(unit_price * qty).toFixed({{optional($general_setting)->decimal}}));
                $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .tax-value').val(parseFloat(tax).toFixed({{optional($general_setting)->decimal}}));
                $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .tax').text(parseFloat(tax).toFixed({{optional($general_setting)->decimal}}));
                item++;
            }
            else {
                changeSaleStatus = 0;
