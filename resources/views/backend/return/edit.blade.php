                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price">{{ number_format((float)$product_return->net_unit_price, optional($general_setting)->decimal, '.', '')}} </td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total">{{ number_format((float)$lims_return_data->total_price, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
