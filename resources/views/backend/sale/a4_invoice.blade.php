...
<html>
    ...
    <body>
        ...
        <table style="width: 100%;border-collapse: collapse;">
            <tr>
                <td colspan="2" style="padding:9px 0;width:40%">
                    ...
                    <div>
                        <span>{{trans('file.VAT Number')}}:</span>&nbsp;&nbsp;<span>{{optional($general_setting)->vat_registration_number}}</span>
                    </div>
                    @endif
                    <?php
                ...
                <td style="width:30%; text-align: middle; vertical-align: top;">
                    <img src="{{url('logo', optional($general_setting)->site_logo)}}" height="80" width="120">
                </td>
        ...
        <table dir="@if( Config::get('app.locale') == 'ar' || optional($general_setting)->is_rtl){{'rtl'}}@endif" style="width: 100%;border-collapse: collapse;">
            ...
            ?>
            <tr>
                <td style="@if( Config::get('app.locale') == 'ar' || optional($general_setting)->is_rtl){{'border-right:1px solid #222;'}}@endif border:1px solid #222;padding:1px 3px;text-align: center;">{{$key+1}}</td>
                ...
                <td style="border:1px solid #222;padding:1px 3px;text-align:center">{{number_format($product_sale_data->net_unit_price, optional($general_setting)->decimal, '.', ',')}}</td>
                <td style="border:1px solid #222;padding:1px 3px;text-align:center">{{number_format(($product_sale_data->net_unit_price * $product_sale_data->qty), optional($general_setting)->decimal, '.', ',')}}</td>
                <td style="border:1px solid #222;padding:1px 3px;text-align:center">{{number_format($product_sale_data->tax, optional($general_setting)->decimal, '.', ',')}}</td>
                <td style="border:1px solid #222;border-right:1px solid #222;padding:1px 3px;text-align:center;font-size: 15px;">{{number_format($product_sale_data->total, optional($general_setting)->decimal, '.', ',')}}</td>
            </tr>
            @endforeach
            <tr>
                <td colspan="3" rowspan="@if(optional($general_setting)->invoice_format == 'gst' && optional($general_setting)->state == 2) 5 @else 4 @endif" style="border:1px solid #222;padding:1px 3px;text-align: center; vertical-align: top;">
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                        {{number_format((float)($lims_sale_data->total_price - ($lims_sale_data->total_tax+$lims_sale_data->order_tax) ) ,optional($general_setting)->decimal, '.', ',')}}
                </td>
            </tr>
            @if(optional($general_setting)->invoice_format == 'gst' && optional($general_setting)->state == 1)
                <tr>
                    ...
                    <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                        {{number_format((float)($lims_sale_data->total_tax+$lims_sale_data->order_tax) ,optional($general_setting)->decimal, '.', ',')}}
                    </td>
                </tr>
            @elseif(optional($general_setting)->invoice_format == 'gst' && optional($general_setting)->state == 2)
                <tr>
                    ...
                    <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                        {{number_format( ($lims_sale_data->total_tax+$lims_sale_data->order_tax) / 2 , optional($general_setting)->decimal, '.', ',')}}
                    </td>
                </tr>
                <tr>
                    <td class="td-text" colspan="3" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);">
            ...
            <tr>
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                    {{number_format((float)($lims_sale_data->total_discount+$lims_sale_data->order_discount) ,optional($general_setting)->decimal, '.', ',')}}
                </td>
            </tr>
            <tr>
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">{{number_format((float)$lims_sale_data->grand_total ,optional($general_setting)->decimal, '.', ',')}}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                    {{number_format((float)$lims_sale_data->paid_amount ,optional($general_setting)->decimal, '.', ',')}}
                </td>
            </tr>
            <tr>
                <td class="td-text" colspan="3" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);">
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                    {{number_format((float)($lims_sale_data->grand_total - $lims_sale_data->paid_amount) ,optional($general_setting)->decimal, '.', ',')}}
                </td>
            </tr>
            <tr>
                <td class="td-text" colspan="3" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);">
                ...
                <td class="td-text" style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                    {{number_format($totalDue ,optional($general_setting)->decimal, '.', ',')}}
                </td>
            </tr>
        </table>
