            ...
            <div class="col-md-6">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    @endif
                                                    <td class="col-sm-2 product-price">{{ number_format((float)($product_sale->total / $product_sale->qty), optional($general_setting)->decimal, '.', '')}}</td>
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Total')}}</span><span id="subtotal">{{number_format((float)$lims_sale_data->total_price, optional($general_setting)->decimal, '.', '')}}</span>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <span id="discount">{{number_format((float)$lims_sale_data->order_discount, optional($general_setting)->decimal, '.', '')}}</span>
                                            @else
                                            <span id="discount">{{number_format(0, optional($general_setting)->decimal, '.', '')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            @if($lims_sale_data->coupon_discount)
                                              <span id="coupon-text">{{number_format((float)$lims_sale_data->coupon_discount, optional($general_setting)->decimal, '.', '')}}</span>
                                            @else
                                              <span id="coupon-text">{{number_format(0, optional($general_setting)->decimal, '.', '')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            @if($lims_sale_data->order_tax)
                                              <span id="tax">{{number_format((float)$lims_sale_data->order_tax, optional($general_setting)->decimal, '.', '')}}</span>
                                            @else
                                              <span id="tax">{{number_format(0, optional($general_setting)->decimal, '.', '')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            @if($lims_sale_data->shipping_cost)
                                              <span id="shipping-cost">{{number_format((float)$lims_sale_data->shipping_cost, optional($general_setting)->decimal, '.', '')}}</span>
                                            @else
                                              <span id="shipping-cost">{{number_format(0, optional($general_setting)->decimal, '.', '')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="payment-amount">
                        <h2>{{trans('file.grand total')}} <span id="grand-total">{{number_format((float)$lims_sale_data->grand_total, optional($general_setting)->decimal, '.', '')}}</span></h2>
                    </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="order_discount" class="form-control numkey" step="any" value="{{number_format((float)$lims_sale_data->order_discount, optional($general_setting)->decimal, '.', '')}}">
                            </div>
            ...
            <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="shipping_cost" class="form-control numkey" value="{{number_format((float)($lims_sale_data->shipping_cost), optional($general_setting)->decimal, '.', '')}}" step="any">
                            </div>
