                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control date" value="{{date(optional($general_setting)->date_format, strtotime($lims_sale_data->created_at->toDateString()))}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>{{date(optional($general_setting)->date_format, strtotime($product_batch_data->expired_date))}}</td>
                                                        @else
                                                        <td>
                                                        ...
                                                        <td>N/A</td>
                                                        @endif
                                                        <td class="net_unit_price">{{ number_format((float)$product_sale->net_unit_price, optional($general_setting)->decimal, '.', '')}} </td>
                                                        <td class="discount">{{ number_format((float)$product_sale->discount, optional($general_setting)->decimal, '.', '')}}</td>
                                                        <td class="tax">{{ number_format((float)$product_sale->tax, optional($general_setting)->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$product_sale->total, optional($general_setting)->decimal, '.', '')}}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th id="total-discount">{{ number_format((float)$lims_sale_data->total_discount, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th id="total-tax">{{ number_format((float)$lims_sale_data->total_tax, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th id="total">{{ number_format((float)$lims_sale_data->total_price, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p class="mt-2 pl-2"><strong id="coupon-text">{{ number_format((float)$lims_sale_data->coupon_discount, optional($general_setting)->decimal, '.', '')}}</strong></p>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $('#subtotal').text(parseFloat($('input[name="total_price"]').val()).toFixed({{optional($general_setting)->decimal}}));
