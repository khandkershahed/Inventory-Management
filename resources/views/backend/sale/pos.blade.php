            ...
            <div class="col-md-7 pos-form">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="form-group top-fields">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="created_at" class="form-control date" value="{{date(optional($general_setting)->date_format,strtotime('now'))}}" onkeyup='saveValue(this);' />
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                        ...
                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                            ...
                            <tbody id="tbody-id">
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2 product-price d-none d-md-block">{{ number_format((float)($product_sale->total / $product_sale->qty), optional($general_setting)->decimal, '.', '')}}</td>
                                    ...
                                    <td class="col-sm-2 sub-total">{{ number_format((float)$product_sale->total, optional($general_setting)->decimal, '.', '')}}</td>
                    ...
                    <div class="row" style="display: none;">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="hidden" name="total_discount" value="@if(isset($lims_sale_data)) {{$lims_sale_data->total_discount}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="hidden" name="total_tax" value="@if(isset($lims_sale_data)) {{$lims_sale_data->total_tax}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="hidden" name="total_price" value="@if(isset($lims_sale_data)) {{$lims_sale_data->total_discount}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="hidden" name="item" value="{{$lims_sale_data->item ?? 0}}" />
                                <input type="hidden" name="order_tax" value="@if(isset($lims_sale_data)) {{$lims_sale_data->order_tax}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="hidden" name="grand_total" value="@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->grand_total, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif"/>
                    ...
                    <div class="col-12 totals" style="background-color:#f5f6f7;border-top: 2px solid #ebe9f1;padding-bottom: 7px;padding-top: 7px;">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-6">
                                <strong class="totals-title">{{trans('file.Total')}}</strong><strong id="subtotal">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->total_price, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</strong>
                            </div>
                            <div class="col-sm-4 col-6">
                                <strong class="totals-title">{{trans('file.Discount')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount-modal"> <i class="dripicons-document-edit"></i></button></strong><strong id="discount">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->order_discount, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</strong>
                            </div>
                            <div class="col-sm-4 col-6">
                                <strong class="totals-title">{{trans('file.Coupon')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></strong><strong id="coupon-text">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->coupon_discount, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</strong>
                            </div>
                            <div class="col-sm-4 col-6">
                                <strong class="totals-title">{{trans('file.Tax')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></strong><strong id="tax">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->order_tax, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</strong>
                            </div>
                            <div class="col-sm-4 col-6">
                                <strong class="totals-title">{{trans('file.Shipping')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></strong><strong id="shipping-cost">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->shipping_cost, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</strong>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="payment-amount d-none d-md-block">
                    <h2>{{trans('file.grand total')}} <span id="grand-total">@if(isset($lims_sale_data)) {{number_format((float)$lims_sale_data->grand_total, optional($general_setting)->decimal, '.', '')}} @else {{number_format(0, optional($general_setting)->decimal, '.', '')}} @endif</span></h2>
                </div>
...
<script type="text/javascript">
    ...
    if(getSavedValue("localStorageQty")) {
        ...
        for(var i = 0; i < localStorageQty.length; i++) {
            ...
            product_discount.push(parseFloat(localStorageProductDiscount[i] / localStorageQty[i]).toFixed({{optional($general_setting)->decimal}}));
    ...
    $('.add-more').on("click", function(e) {
        ...
        var more_to_pay = ($("#grand-total").text() - total_paid_amount).toFixed({{optional($general_setting)->decimal}});
...
function getProduct(warehouse_id){
    ...
    function convertDate(isoDate) {
        ...
        if('{{optional($general_setting)->date_format}}' == 'd-m-Y') {
            return day + '-' + month + '-' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'd/m/Y') {
            return day + '/' + month + '/' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'd.m.Y') {
            return day + '.' + month + '.' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'm-d-Y') {
            return month + '-' + day + '-' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'm/d/Y') {
            return month + '/' + day + '/' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'm.d.Y') {
            return month + '.' + day + '.' + year;
        } else if('{{optional($general_setting)->date_format}}' == 'Y-m-d') {
    ...
    function change(paying_amount, paid_amount) {
        $("#change").text( parseFloat(paying_amount - paid_amount).toFixed({{optional($general_setting)->decimal}}));
    }
    ...
    function updateChange() {
        ...
        $('.change').text((change).toFixed({{optional($general_setting)->decimal}}));
    }
    ...
    $(document).on('click', '.qc-btn', function(e) {
        if($(this).data('amount')) {
            if($('.qc').data('initial')) {
                $('input[name="paying_amount"]').val($(this).data('amount').toFixed({{ optional($general_setting)->decimal }}));
                $('.qc').data('initial', 0);
            }else {
                $('input[name="paying_amount"]').val( (parseFloat($('input[name="paying_amount"]').val()) + $(this).data('amount')).toFixed({{optional($general_setting)->decimal}}));
            }
        }
        else
            $('input[name="paying_amount"]').val('{{number_format(0, optional($general_setting)->decimal, '.','')}}');
    ...
    function addNewProduct(data){
        ...
        localStorageTaxRate.splice(rowindex, 0, tax_rate[rowindex].toFixed({{optional($general_setting)->decimal}}));
        ...
        localStorageNetUnitPrice.splice(rowindex, 0, '{{number_format(0, optional($general_setting)->decimal, '.', '')}}');
        localStorageTaxValue.splice(rowindex, 0, '{{number_format(0, optional($general_setting)->decimal, '.', '')}}');
        localStorageSubTotalUnit.splice(rowindex, 0, '{{number_format(0, optional($general_setting)->decimal, '.', '')}}');
        localStorageSubTotal.splice(rowindex, 0, '{{number_format(0, optional($general_setting)->decimal, '.', '')}}');
                ...
                if($("#coupon-code").val() == value['code']){
                    ...
                    if(parseFloat(value['quantity']) <= parseFloat(value['used']))
                        ...
                        if(parseFloat($('input[name="grand_total"]').val()) >= value['minimum_amount']) {
                            ...
                            $('#grand-total').text(parseFloat($('input[name="grand_total"]').val()).toFixed({{optional($general_setting)->decimal}}));
                            $('#grand-total-m').text(parseFloat($('input[name="grand_total"]').val()).toFixed({{optional($general_setting)->decimal}}));
                            ...
                            $('#coupon-text').text(parseFloat(value['amount'] * currency['exchange_rate']).toFixed({{optional($general_setting)->decimal}}));
                        }
                        else
                        ...
                        $('#grand-total').text(parseFloat(grand_total).toFixed({{optional($general_setting)->decimal}}));
                        $('#grand-total-m').text(parseFloat(grand_total).toFixed({{optional($general_setting)->decimal}}));
                        if(!$('input[name="coupon_active"]').val())
                        ...
                        $('#coupon-text').text(parseFloat(coupon_discount).toFixed({{optional($general_setting)->decimal}}));
                    }
                }
            });
            if(!valid)
    ...
    function calculateRowProductData(quantity) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.product-price').text(sub_total_unit.toFixed({{optional($general_setting)->decimal}}));
        ...
        localStorageProductDiscount.splice(rowindex, 1, (product_discount[rowindex] * quantity).toFixed({{optional($general_setting)->decimal}}));
        localStorageTaxRate.splice(rowindex, 1, tax_rate[rowindex].toFixed({{optional($general_setting)->decimal}}));
        localStorageNetUnitPrice.splice(rowindex, 1, net_unit_price.toFixed({{optional($general_setting)->decimal}}));
        localStorageTaxValue.splice(rowindex, 1, tax.toFixed({{optional($general_setting)->decimal}}));
        localStorageSubTotalUnit.splice(rowindex, 1, sub_total_unit.toFixed({{optional($general_setting)->decimal}}));
        localStorageSubTotal.splice(rowindex, 1, sub_total.toFixed({{optional($general_setting)->decimal}}));
        localStorage.setItem("localStorageProductDiscount", localStorageProductDiscount);
        localStorage.setItem("localStorageTaxRate", localStorageTaxRate);
        localStorage.setItem("localStorageNetUnitPrice", localStorageNetUnitPrice);
        localStorage.setItem("localStorageTaxValue", localStorageTaxValue);
    ...
    function calculateGrandTotal() {
        ...
        $("#discount").text(order_discount.toFixed({{optional($general_setting)->decimal}}));
        ...
        if (!coupon_discount)
            coupon_discount = {{number_format(0, optional($general_setting)->decimal, '.', '')}};
        grand_total -= coupon_discount;

        $('#item').text(item);
        $('input[name="item"]').val($('table.order-list tbody tr:last').index() + 1);
        $('#subtotal').text(subtotal.toFixed({{optional($general_setting)->decimal}}));
        $('#tax').text(order_tax.toFixed({{optional($general_setting)->decimal}}));
        $('input[name="order_tax"]').val(order_tax.toFixed({{optional($general_setting)->decimal}}));
        $('#shipping-cost').text(shipping_cost.toFixed({{optional($general_setting)->decimal}}));
        $('input[name="shipping_cost"]').val(shipping_cost);
        $('#grand-total').text(grand_total.toFixed({{optional($general_setting)->decimal}}));
        $('#grand-total-m').text(grand_total.toFixed({{optional($general_setting)->decimal}}));
        $('input[name="grand_total"]').val(grand_total.toFixed({{optional($general_setting)->decimal}}));
