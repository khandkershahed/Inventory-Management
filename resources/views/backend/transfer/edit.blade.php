                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control date" value="{{date(optional($general_setting)->date_format, strtotime($lims_transfer_data->created_at->toDateString()))}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_cost">{{ number_format((float)$product_transfer->net_unit_cost, optional($general_setting)->decimal, '.', '')}} </td>
                                                        <td class="tax">{{ number_format((float)$product_transfer->tax, optional($general_setting)->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$product_transfer->total, optional($general_setting)->decimal, '.', '')}}</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th id="total-tax">{{ number_format((float)$lims_transfer_data->total_tax, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th id="total">{{ number_format((float)$lims_transfer_data->total_cost, optional($general_setting)->decimal, '.', '')}}</th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
